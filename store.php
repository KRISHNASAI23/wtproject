...
if(isset($_POST['Submit']))
{
	...
	$sql="insert into register(firstname,lastname,gender,dateofbirth,username,password,confirmpassword,address,pincode,mobileno,email)values
	('$fn','$ln','$gen','$dt','$un','$pwd','$cp','$ad','$pc','$mn','$em');";
